"ace" in window || (window.ace = {}), "helper" in window.ace || (window.ace.helper = {}), "vars" in window.ace || (window.ace.vars = {
    ...
    if (e.fn.ace_scroll) {
        ...
        if (u && v) {
            ...
            }, x = k(), T = o.hasClass("h-sidebar"), H = ace.helper.sidebar_scroll = {
    ...
    e(document).on("hide.bs.collapse show.bs.collapse", function (a) {
        ...
        e('[href*="#' + t + '"]').find(ace.vars[".icon"]).each(function () {
            ...
            return (i = s.attr("data-icon-show")) ? n = s.attr("data-icon-hide") : (t = s.attr("class").match(/fa\-(.*)\-(up|down)/)) && (i = "fa-" + t[1] + "-down", n = "fa-" + t[1] + "-up"), i ? ("show" == a.type ? s.removeClass(i).addClass(n) : s.removeClass(n).addClass(i), !1) :
			void 0
        })
    });
    var a = function (a) {
    ...
    e.fn.widget_box = function (t, s) {
        ...
        if (0 != i.length && !i.hasClass("ui-sortable-helper")) {
            ...
            if ("collapse" == r) {
                ...
                if (i.trigger(o = e.Event(l + ".ace.widget")), o.isDefaultPrevented())
                    return;
                n.toggle(l, s)
            } else if ("close" == r) {
                var o;
                if (i.trigger(o = e.Event("close.ace.widget")), o.isDefaultPrevented())
                    return;
                n.close()
            } else if ("reload" == r) {
                s.blur();
                var o;
                if (i.trigger(o = e.Event("reload.ace.widget")), o.isDefaultPrevented())
                    return;
                n.reload()
            } else if ("fullscreen" == r) {
                var o;
                if (i.trigger(o = e.Event("fullscreen.ace.widget")), o.isDefaultPrevented())
                    return;
                n.fullscreen()
            } else
